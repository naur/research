...
/*-------------------- 全局变量 START ----------------*/
var global = {
    naur: null, structures: null, overlay: null, message: null, http: null, graphics: [], lines: null, volumes: null, finance: null, systemFinance: null, systemEquation: null, exponents: [], coordinate: null,
    accesskey: 'F2',
    color: ['#800000', '#0000A0'],
...
require(['jquery', 'naur.message', 'naur.ui.overlay', 'naur.http.xsl', 'naur.math.statistics.finance',
    'naur.graphics.equation',
    'naur.graphics.finance'], function ($, NAUR) {
    global.naur = NAUR;
    global.structures = NAUR.Math.Structures;
    global.overlay = NAUR.UI.Overlay;
    global.http = NAUR.HTTP;
    global.message = NAUR.Message;
    global.finance = NAUR.Math.Statistics.Finance;
    global.systemFinance = new NAUR.Graphics.Finance();
    global.systemEquation = new NAUR.Graphics.Equation();
    ...
    $(function () {
        ...
        global.graphics[0] = $(dom.canvas[0]).NAUR_Graphics({system: global.systemFinance});
        global.graphics[1] = $(dom.canvas[1]).NAUR_Graphics({system: new NAUR.Graphics.Finance()});
