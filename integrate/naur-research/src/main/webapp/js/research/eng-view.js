...
var overlayNodes = {
    Get:function () {
        ...
        $('article section:eq(1)').NAUR_HTTP_Acquire({
...
require(['jquery', 'naur.message', 'naur.ui.overlay', 'naur.http.xsl', 'naur.analytics'], function ($, NAUR) {
    naur = NAUR;
    message = NAUR.Message;
    overlay = NAUR.UI.Overlay;
    http = NAUR.HTTP;
