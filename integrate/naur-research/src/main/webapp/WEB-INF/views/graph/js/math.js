...
Number.prototype.roots = function () {
    return [];
};
...
Number.prototype.singularities = function () {
    return [];
};
String.prototype.singularities = function () {
    return [];
...
(function () {
    ...
    if (typeof JSON.stringify !== 'function') {
        JSON.stringify = function (value, dreplacer, space) {
            var i;
            gap = '';
            indent = '';
            ...
            rep = dreplacer;
            if (dreplacer && typeof dreplacer !== 'function' && (typeof dreplacer !== 'object' || typeof dreplacer.length !== 'number')) {
