package org.naur.research.web.controllers.learn;
...
//import org.naur.common.patterns.TreeType;
import org.naur.common.patterns.Type;
import org.naur.common.patterns.exception.Sub;
import org.naur.repositories.models.learn.Schedule;
import org.naur.research.services.ScheduleService;
    ...
    public Information get(@PathVariable final String params) {
        return handler(new Sub<Information>() {
            ...
            public Information execute() throws Exception {
                ...
                map.put(Type.Sort.name(), new Tree<String>(Type.Sort, "path"));
