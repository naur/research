...
define(['naure.ui', 'naure.utility'], function (NAURE) {
        var utility = NAURE.Utility;

        NAURE.UI.Echarts = (function () {
            var echarts = {
                options: {
                    line: {
                        grid: {
            ...
            echarts.getChartOption = function (axis) {
                ...
                var opt = {
                    ...
                    dataZoom: {
                        ...
                        start: axis.dataZoomLimit < axis.points.keys.length ? (axis.points.keys.length - axis.dataZoomLimit) / axis.points.keys.length * 100 : 80
                    },
                    xAxis: [
                        {
