...
define(['jquery', 'naur'], function($, NAUR) {
     ...
     * });
     */
    NAUR.UI.DropdownPrompt = (function () {
...
//                obj.container = container;
    ...
    $.fn.naur_ui_templet = function (options) {
        if (!options) {
            options = {};
        }
