 ...
 *      <input type="button" title="Clean" onclick="NAUR.Message.empty();"/>
...
define(['jquery', 'jquery.strings', 'naur', 'naur.utility', 'naur.ui'], function ($, $1, NAUR) {

    NAUR.UI.Overlay = (function () {
        var dom = {
            overlay: '.overlay',
            ...
            init: function (options) {
                ...
                for (key in opt.nodes) {
                    ...
                    $(dom.overlaySection).append($.format(opt.html,
                        ...
                        isRichNode ? NAUR.JSON.toHtml(opt.nodes[key].input) : 'type=checkbox',
