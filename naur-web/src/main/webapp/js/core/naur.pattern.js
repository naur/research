...
define('naur.pattern', ['jquery', 'naur'], function ($, NAUR) {

    NAUR.Pattern = (function () {
...
/**
 * 基于 naur.http.ajax 版本的
 */
define('naur.pattern.ajax', ['jquery', 'naur.pattern', 'naur.http.ajax'], function ($, NAUR) {
    NAUR.Pattern.http = NAUR.HTTP;
    return NAUR;
});


/**
 * 基于 naur.http.xsl 版本的
 */
define('naur.pattern.xsl', ['jquery', 'naur.pattern', 'naur.http.xsl'], function ($, NAUR) {
    NAUR.Pattern.http = NAUR.HTTP;
    return NAUR;
});
...
//        }, options);
//
//        $(opt.container).NAUR_HTTP_Acquire({
//            xml: opt.xml,
//            xmlUrl: opt.xmlUrl,
...
//                    NAUR.Message.show({content: opt.errorPrompt, color: 'red', inline: true});
//                }
//                if (opt.error) {
//                    opt.error(ex);
//                }
...
//                    NAUR.Message.show({content: opt.emptyPrompt, color: 'red', inline: true});
