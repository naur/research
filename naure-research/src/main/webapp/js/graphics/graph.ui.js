...
var ui = {
    ...
    "add":function(n) {
        ...
        delete_.addEventListener("mouseup", function(e) {
            app.remove(li);
            e.stopPropagation();
        }, false);
    ...
    "init":function(fullscreen) {
        ...
        if (window.addEventListener) {
            ...
            con.addEventListener("mousewheel", function(e) {
                e.stopPropagation();
            }, false);
            con.addEventListener("DOMMouseScroll", function(e) {
                e.stopPropagation();
            }, false);
        } else {
            window.onmousewheel = window.DOMMouseScroll = mousewheel;
            con.onmousewheel = window.onDOMMouseScroll = function(e) {
                e.stopPropagation();
            };
        }
