...
//                }
            ...
            Graph:function (n, disabled) {
                ...
                t.gid = random_hash();
                t.disabled = disabled;
                t.color = ui.config.colors.free.pop();
...
//                graph.plot(this.ctx);
                ...
                var x = ui.currCoord.X1 //boundleft;
                ui.ctx.move(x, pow(x, 2));
                for (var x = ui.currCoord.x1; x < ui.currCoord.x2; x += (ui.currCoord.x2 - ui.currCoord.x1) / ui.width) {
...
//                    }
            ...
            init:function (options) {
                ...
                this.ctx.move = function (px, py, pz) {
                    ...
                    if (px > ui.currCoord.X2) {
                        px = ui.currCoord.X2;
                    }
                    if (px < ui.currCoord.X1) {
                        px = ui.currCoord.X1;
                    }
                    if (py > ui.currCoord.y2) {
                        py = ui.currCoord.y2;
                    }
                    if (py < ui.currCoord.Y1) {
                        py = ui.currCoord.Y1;
                    }
                    return ui.ctx.moveTo(ui.scale.x * px - ui.centerPosition.X, ui.centerPosition.Y - ui.scale.y * py);
//                    return;
//                    if (!isNaN(py)) {
//                        if (py > boundtop * 4) {
//                            ctx.moveTo(scale.x * (px - cx), scale.y * (cy - boundtop * 4));
//                            return;
//                        } else if (py < boundbottom * 4) {
//                            ctx.moveTo(scale.x * (px - cx), scale.y * (cy - boundbottom * 4));
//                            return;
//                        }
//                        ctx.moveTo(scale.x * (px + cx), scale.y * (-cy - py));
//                    }
                };
                this.ctx.line = function (px, py, pz) {
                    ...
                    return ui.ctx.lineTo(ui.scale.x * px - ui.centerPosition.X, ui.centerPosition.Y - ui.scale.y * py);
//                    ctx.lineTo(scale.x * px - cx, cy - scale.y * py);
//                    return;
//                    if (!isNaN(py)) {
//                        if (py > boundtop * 4) {
//                            ctx.lineTo(scale.x * (px - cx), scale.y * (cy - boundtop * 4));
//                            return;
//                        } else if (py < boundbottom * 4) {
//                            ctx.lineTo(scale.x * (px - cx), scale.y * (cy - boundbottom * 4));
//                            return;
//                        }
//                        ctx.lineTo(scale.x * (px - cx), scale.y * (cy - py));
//                    }
                };
                ...
                this.centerPosition = {X:ui.width / -2, Y:ui.height / 2};
                this.scale = this.currScale();
...
//                },
//
//                scalex = ui.width / (-this.currCoord.x1 + this.currCoord.x2);
